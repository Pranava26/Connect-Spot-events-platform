import CheckoutButon from "@/components/shared/CheckoutButon";
...
const EventDetails = async ({ params: { id }, searchParams }) => {
  ...
  return (
    ...
    <section className="wrapper my-8 flex flex-col gap-8 md:gap-12">
      ...
      <Collection data={relatedEvents?.data} emptyTitle="No Events Found" emptyStateSubtext="Come back later" collectionType="All_Events" limit={3} page={searchParams.page} totalPages={relatedEvents?.totalPages} />
    </section>
    </>
  )
}
